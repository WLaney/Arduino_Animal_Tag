...
// so be careful!
void Light_L3GD20::read(int16_t s[3])
{ 
...
/***************************************************************************
 PRIVATE FUNCTIONS
 ***************************************************************************/
void Light_L3GD20::write8(l3gd20Registers_t reg, byte value)
{
  Wire.beginTransmission(address);
  Wire.write((byte)reg);
  Wire.write(value);
...
byte Light_L3GD20::read8(l3gd20Registers_t reg)
{
  byte value;
